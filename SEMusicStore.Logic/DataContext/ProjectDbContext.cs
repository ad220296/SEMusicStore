//@CodeCopy
using SEMusicStore.Common.Modules.Exceptions;
...
{
    /// <summary>
    /// Represents the database context for the SEMusicStore application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=SEMusicStore.db";
        #endregion fields
