//@CodeCopy
#if ACCOUNT_ON
using SEMusicStore.Logic.Entities.Account;
using SEMusicStore.Logic.Modules.Exceptions;
using SEMusicStore.Logic.Modules.Security;
using System.Text;
using System.Text.RegularExpressions;

namespace SEMusicStore.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEMusicStore.Common.Modules.ThreadSafe;
